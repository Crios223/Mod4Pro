...
//  * Creates a new spot image for a given spot.
//  * Authentication: true
//  * Expects a JSON body with: { url, preview }
//  */
...
//     // Debug logging: print the authenticated user and spotId
//     console.log("Creating Spot Image for spotId:", spotId);
...
//     // Default preview to false if not provided
//     const previewValue = preview ? true : false;
...
//     });
//   } catch (err) {
//     console.error("Error in POST /api/spots/:spotId/images:", err);
//     next(err);
//   }
// });
